# use array to present "binary heap", but use "complete binary tree" to understand
# The position of i's left child is (2*i + 1)
# The position of i's right child is (2*i + 2)
# The position of i's parent is floor((i - 1)/2)
